defmodule Weatherman.SnowDownloader do

  alias Weatherman.Constants

  def start_snow_download(date) do
    base_url = "https://dd.weather.gc.ca/observations/swob-ml/partners/bc-env-snow/"
    dest_base = "/home/dj/data/datamart/swob_partners/bc_snow/"

    # stns = Constants.bc_snow_stations()
    stns = Constants.bc_snow_new_stns()
