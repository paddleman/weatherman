defmodule Weatherman.ForestryDownloader do

  alias Weatherman.Constants

  def start_forestry_download(date) do
    base_url = "https://dd.weather.gc.ca/observations/swob-ml/partners/bc-forestry/"
    dest_base = "/home/dj/data/datamart/swob_partners/bc_forestry/"

    # stns = Constants.bc_forestry_stations()
    stns = Constants.bcfs_new_stns()
