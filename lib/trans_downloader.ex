defmodule Weatherman.TransDownloader do

  alias Weatherman.Constants

  def start_trans_download(date) do
    base_url = "https://dd.weather.gc.ca/observations/swob-ml/partners/bc-tran/"
    dest_base = "/home/dj/data/datamart/swob_partners/bc_trans/"

    # stns = Constants.bc_trans_stations()
    stns = Constants.bc_trans_new_stns()
  ...
  def get_xml_names(stn_num, date, base_url, dest) do
    daily_download_url = base_url <> date <> "/" <> stn_num <> "/"
    dest_dir = "#{dest}#{stn_num}/#{date}/"
