defmodule Weatherman.EnvDownloader do

  alias Weatherman.Constants

  def start_env_download(date) do
    base_url = "https://dd.weather.gc.ca/observations/swob-ml/partners/bc-env-aq/"
    dest_base = "/home/dj/data/datamart/swob_partners/bc_env/"

    stns = Constants.bc_env_stations()
    # stns = Constants.bc_env_new_stns()
